...
Gallery for Tezos NFTs plugin uses objkt.com ([Terms](https://objkt.com/terms)) public API v3 to obtain data automatically, without any action required when new NFTs are added to the wallet address configured.
